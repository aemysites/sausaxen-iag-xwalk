...
## Environments
- Preview: https://main--sausaxen-iag-xwalk--aemysites.aem.page/
- Live: https://main--sausaxen-iag-xwalk--aemysites.aem.live/
- Block Library: https://main--sausaxen-iag-xwalk--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `sausaxen-iag-xwalk` directory in your favorite IDE and start coding :)
